...
cp "/mxe/usr/${TOOLCHAIN}/bin/opengl32.dll" "/out/usr/bin"
#cp "/out/usr/bin/opengl32.dll" "/out/usr/bin/full_opengl32.dll" # Provide a full, unstripped dll for debugging.
