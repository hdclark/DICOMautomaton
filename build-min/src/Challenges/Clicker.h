...
//   1-2: Plain button near bottom of window
//   3-4: Slowly wanders around the window imperceptibly
//   5-6: Avoids mouse cursor, gets tired, animated breathing
//   7-8: Bends/flexes like rubber when clicked (temporary)
//   9-10: Requires 3 clicks
