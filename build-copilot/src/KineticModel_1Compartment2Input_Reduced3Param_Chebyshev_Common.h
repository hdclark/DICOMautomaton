//KineticModel_1Compartment2Input_Reduced3Param_Chebyshev_Common.h.
...
struct KineticModel_1Compartment2Input_Reduced3Param_Chebyshev_Parameters {
    ...
    double RSS  = std::numeric_limits<double>::quiet_NaN(); // Residual sum of squares == $F$.
    ...
    double S_IV_R   = std::numeric_limits<double>::quiet_NaN();
    double S_IA_IA  = std::numeric_limits<double>::quiet_NaN();
...
struct KineticModel_1Compartment2Input_Reduced3Param_Chebyshev_Results {
...
void
Evaluate_Model( const KineticModel_1Compartment2Input_Reduced3Param_Chebyshev_Parameters &state,
                const double t,
                KineticModel_1Compartment2Input_Reduced3Param_Chebyshev_Results &res);
