...
#                               debian_bullseye, debian_stretch, fedora, macos, mxe, ubuntu, void
...
#                               Fedora
####################################################################################
get_fedora_build_tools_required() {
    printf '\n'
}

get_fedora_build_tools_optional() {
    printf '\n'
}

get_fedora_development_required() {
    printf '\n'
}

get_fedora_development_optional() {
    printf '\n'
}

get_fedora_ygor_deps_required() {
    printf '\n'
}

get_fedora_ygor_deps_optional() {
    printf '\n'
}

get_fedora_dcma_deps_required() {
    printf '\n'
}

get_fedora_dcma_deps_optional() {
    printf '\n'
}

get_fedora_appimage_runtime_required() {
    printf 'bash '
    printf 'git '
    printf 'rsync '
    printf 'wget '
...
get_fedora_appimage_runtime_optional() {
    printf '\n'
}
...
normalize_os() {
    ...
    case "$os" in
        ...
        void|void_linux|voidlinux)
            ...
            ;;
        *)
            error_exit "Unknown OS: $os. Valid options: alpine, arch, arch_sycl, debian_buster, debian_bookworm, debian_bullseye, debian_stretch, fedora, macos, mxe, ubuntu, void"
            ;;
    esac
}
