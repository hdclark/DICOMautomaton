...
#    ./AppDir/AppRun -h # Test the script is functional.
    ...
    cp "/linuxdeploy_artifacts/f2df956789f36204213876c96500c8b05595e43b_excludelist" -O excludelist_proto ||
    ...
    cp "/appimagekit_artifacts/obsolete-appimagetool-${ARCH}.AppImage" -O ./appimagetool-${ARCH}.AppImage ||
