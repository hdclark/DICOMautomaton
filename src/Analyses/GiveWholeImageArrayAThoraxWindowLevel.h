//GiveWholeImageArrayAThoraxWindowLevel.h.
...
Drover GiveWholeImageArrayAThoraxWindowLevel(Drover DICOM_data, std::map<std::string,std::string> /*InvocationMetadata*/, std::string /*FilenameLex*/);
