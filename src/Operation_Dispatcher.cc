...
#include "Operations/GenerateSyntheticDataPointCloudV1.h"
...
known_ops_t Known_Operations(){
    ...
    out["GenerateSyntheticDataPointCloudV1"] = std::make_pair(OpArgDocGenerateSyntheticDataPointCloudV1, GenerateSyntheticDataPointCloudV1);
