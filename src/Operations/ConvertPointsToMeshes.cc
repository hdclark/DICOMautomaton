...
OperationDoc OpArgDocConvertPointsToMeshes(){
    ...
    out.args.back().desc = "There are currently two supported methods:"
                           " 'expand' -- represents each point as a small cube;"
                           " 'convexhull' -- computes the convex hull of all points."
                           " The 'expand' method is useful for visualization and creating volumetric representations."
                           " The 'convexhull' method is useful for creating a minimal bounding surface.";
    ...
    out.args.back().desc = "The width (side length) of each cube representing a point."
                           ...
                           " Only used with the 'expand' method.";
