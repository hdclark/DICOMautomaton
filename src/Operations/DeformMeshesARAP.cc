...
OperationDoc OpArgDocDeformMeshesARAP(){
    ...
    out.args.back().desc = "A semicolon-separated list of hard vertex constraints. Each constraint is specified as:"
    ...
    out.args.back().desc = "A semicolon-separated list of soft vertex constraints. Each constraint is specified as:"
