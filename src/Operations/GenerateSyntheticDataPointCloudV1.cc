//GenerateSyntheticDataPointCloudV1.cc - A part of DICOMautomaton 2026. Written by hal clark.
...
#include "GenerateSyntheticDataPointCloudV1.h"


OperationDoc OpArgDocGenerateSyntheticDataPointCloudV1(){
    OperationDoc out;
    out.name = "GenerateSyntheticDataPointCloudV1";
...
bool GenerateSyntheticDataPointCloudV1(Drover &DICOM_data,
    ...
    pc_ptr->pset.metadata["PointCloudLabel"] = "SyntheticCubeSample";
    pc_ptr->pset.metadata["Description"] = "Synthetic point cloud sampled from cube";
    pc_ptr->pset.metadata["ContentDate"] = "20260129";
    pc_ptr->pset.metadata["ContentTime"] = "022000";
