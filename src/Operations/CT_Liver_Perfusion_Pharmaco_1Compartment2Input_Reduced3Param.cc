//CT_Liver_Perfusion_Pharmaco_1C2I_Reduced3Param.cc - A part of DICOMautomaton 2015, 2016. Written by hal clark.
...
Drover CT_Liver_Perfusion_Pharmaco_1C2I_Reduced3Param(Drover DICOM_data, const OperationArgPkg& OptArgs, const
...
std::list<OperationArgPkg>& /*Children*/){
    ...
    KineticModel_Liver_1C2I_Reduced3Param_Chebyshev_UserData ud_cheby; 
    ...
    for(auto & img_arr : C_enhancement_img_arrays){
        ...
        if(!pharmaco_model_dummy.back()->imagecoll.Process_Images_Parallel( 
                          ...
                          KineticModel_Liver_1C2I_Reduced3Param_Chebyshev_FreeformOptimization,
