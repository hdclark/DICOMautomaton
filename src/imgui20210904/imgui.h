...
namespace ImGui
{
    ...
    IMGUI_API void                  TableSetColumnWidth(int column_n, float width);  // [[ NOTE: added by hc on 20230810 -- seems to have been omitted here, but available in imgui_tables.cpp as a public function. ]]
